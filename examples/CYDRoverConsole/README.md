...
- `CYDRoverConsole.ino`: menu declaration, backing values, callbacks, setup, and loop
- `RoverConsoleDisplay.h/.cpp`: CYD `TFT_eSPI` display adapter and RoverConsole skin
